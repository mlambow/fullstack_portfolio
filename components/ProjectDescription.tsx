    ...
    return (
        <>
            ...
            <p
                ...
                className={`text-sm text-muted-foreground font-extralight leading-relaxed max-w-xl line-clamp-3 ${
            ...
            {isOpen && (
                ...
                >
                    {/* Modal Card Content */}
                    <div
                        onClick={(e) => e.stopPropagation()} // Prevents closing when clicking inside the text box
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between border-b border-border/40 pb-4">
                            ...
                            <button
                                onClick={() => setIsOpen(false)}
                                className="text-foreground hover:text-rose-600 hover:bg-rose-600/20 py-2 px-3 rounded-2xl transition-all duration-200 font-mono text-xs cursor-pointer"
                            >
                                [ CLOSE ]
                            </button>
                        </div>
                        ...
                        <p className="text-sm text-foreground font-extralight leading-relaxed whitespace-pre-line">
                            {description}
                        </p>
                    </div>
                </div>
